...
public class GetName 
{
	...
	public void f() throws InterruptedException 
	  { 
	     ...
	     driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div/div/div[2]/ul[3]/li/admin-menu/ul/ul[1]/li[5]/a")).click();
	     Thread.sleep(10000);
	   
	   String Before="/html/body/div[1]/section/div/div/div/div/div/div/div/div/div[1]/div[3]/div/div[";
	   String After=" ]/div[1]/div[2]/div[1]";
	   String Before_Edit="/html/body/div[1]/section/div/div/div/div/div/div/div/div/div[1]/div[3]/div/div[";
	   String After_Edit= "]/div[3]/button[1]";
	   for (int j = 3; j <= 12; j++) 
	   {  
	       ...
	       System.out.println(get_email);
		       ...
		       driver.findElement(By.xpath("/html/body/div[1]/div/div/div/form/div[1]/div/ul/li[7]/a")).click();
